    ...
    do
    {
        ...
        switch(ch)
        {
            case 1: cout<<"enter the values of line coordinates: ";
                    cin>>x1>>y1>>x2>>y2;
                    cout<<"\nenter the value of shearing for x-axis: ";
                    cin>>x;
                    cout<<"\nenter the value of shearing for y-axis: ";
                    cin>>y;
                    cleardevice();
                    line(x1,y1,x2,y2);
            ...
            case 2: cout<<"enter the top left coordinates: ";
                    ...
                    cin>>x2>>y2;
                    cout<<"\nenter the values of shearing coordinate for x_shear: ";
                    cin>>x;
                    cout<<"\nenter the values of shearing coordinate for y_shear: ";
                    cin>>y;
                    delay(1000);
                    cleardevice();
            ...
            case 3: cout<<"enter coordinates of line1: ";
                    ...
                    cin>>x3>>y3;
                    cout<<"\nenter shear coordinate for x_shear: "; 
                    cin>>x; 
                    cout<<"\nenter shear coordinate for y_shear: ";
                    cin>>y;
